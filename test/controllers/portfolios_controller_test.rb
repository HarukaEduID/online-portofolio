...
class PortfoliosControllerTest < ActionController::TestCase
  ...
  test "should create portfolio" do
    assert_difference('Portfolio.count') do
      post :create, portfolio: { date: @portfolio.date, description: @portfolio.description, tags: @portfolio.tags, title: @portfolio.title }
    end
  ...
  test "should update portfolio" do
    patch :update, id: @portfolio, portfolio: { date: @portfolio.date, description: @portfolio.description, tags: @portfolio.tags, title: @portfolio.title }
    assert_redirected_to portfolio_path(assigns(:portfolio))
  end
